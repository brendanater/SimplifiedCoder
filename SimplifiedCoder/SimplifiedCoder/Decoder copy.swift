...
//protocol UnassociatedDecoderBase: class, Decoder, SingleValueDecodingContainer {
//
...
//}
//
//protocol DecoderBase: UnassociatedDecoderBase {
//
//    associatedtype KeyedContainerType: DecoderKeyedContainer
//    associatedtype UnkeyedContainerType: DecoderUnkeyedContainer
...
//
//    init(value: Any, codingPath: [CodingKey], untypedOptions: Any, userInfo: [CodingUserInfoKey : Any]) {
//        guard let options = untypedOptions as? Options else { fatalError("Tried to set options with incorrect untypedOptions: \(untypedOptions)") }
...
//    }
//
//    /// casts an error to the right type at the codingPath, delegates a known error, or catches an unknown error and adds the path information
//    func error(_ error: Error, at codingPath: [CodingKey]) -> Error {
//
//        if let error = error as? UnboxError {
//            return error.asDecodingError(with: codingPath)
...
//
////    associatedtype UnkeyedContainerType
...
//
//    // init(decoder: BaseDecoder, container: NSDictionary, nestedPath: [CodingKey])
//
...
//
//        guard let container = value as? NSDictionary else {
//            throw decoder.failedToUnbox(value, to: KeyedDecodingContainer<K>.self, "nested keyed container")
//                .asDecodingError(with: codingPath + [key])
//        }
//
//        return KeyedDecodingContainer(
...
//}
//
//protocol DecoderUnkeyedContainer {
//
//    associatedtype KeyedContainerType: DecoderKeyedContainer
//    associatedtype Base: DecoderBase
//
...
//    var nestedPath: [CodingKey] {get}
//
//    // init(decoder: BaseDecoder, container: NSArray, nestedPath: [CodingKey])
//
